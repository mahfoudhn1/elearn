...
from .views import FieldOfStudysView, ScheduleViewSet, StudentGroupRequestViewSet, TeacherGroupRequestViewSet, GroupViewSet
...
router.register(r'fieldofstudy', FieldOfStudysView, basename='grades')
