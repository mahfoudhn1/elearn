...
function Howitworks() {
  return (
   ...
   <div className="relative flex  flex-col min-w-0 break-words mb-6 bg-white pr-6 shadow-soft-xl rounded-2xl bg-clip-border">
      <div className="flex-auto p-4">
         <div className="flex flex-wrap -mx-3 ">
            ...
            <div className="max-w-full px-3 mt-12 ml-auto md:flex hidden text-center lg:mt-0 lg:w-5/12 lg:flex-none">
...
<div className="w-full max-w-full px-3 lg:w-5/12 mb-6 lg:flex-none">
