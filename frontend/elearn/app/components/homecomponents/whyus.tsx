...
function Whyus() {
  return (
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-lg text-gray-dark mb-12">تعرف على الأسباب التي تجعلك تختار منصة رفعة</p>
      <div className="flex flex-col sm:flex-row sm:justify-between gap-8">
        <div className="flex-1 min-w-[300px]  bg-white rounded-lg p-6 shadow-md rtl:text-right">
          ...
          <p className="text-gray-dark rtl:text-right">
            يتم اختيار أفضل المدرسين بناءا على أفضل المستويات و سنين الخبرة لتوفير جو دراسي مثمر.
          </p>
        </div>
        <div className="flex-1 min-w-[300px] bg-white rounded-lg p-6 shadow-md rtl:text-right">
          <div className="text-4xl text-green mb-4">
